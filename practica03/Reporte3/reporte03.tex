...
\\GLCM. Matriz de cocurrencia de nivel gris (Gray-level cocurrence matrix)  es un método estad´sitico para examinar texturas que considera una relación espacial de pixelex-
...
Más análisiss son necesarios relacionados a cada una y se necesitan
